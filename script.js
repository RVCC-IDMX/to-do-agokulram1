...
const newTaskInput = document.querySelector('[data-new-task-form]')
...
(LOCAL_STORAGE-SELECTED-LIST_ID_KEY)
...
deleteListButton.addEventListener('click', e =>{
    lists = lists.filter(list.id !== selectedListID)
    selectedListId = null
    saveAndRender()
})
...
function createTask(name) {
    return {id: Date.now().toString(), name: name, complete:[
